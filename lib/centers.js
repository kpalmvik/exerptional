(function() {
  ...
  */
  ...
  var retrieveHtml = function(baseConfig) {
    var baseUrl = baseConfig.url,
        baseCenterId = baseConfig.centerId,
        getCenterUrl = baseUrl + centerListPage;
  ...
  var Centers = module.exports = function(baseConfig) {
    var allCenters = function() {
      return retrieveHtml(baseConfig).then(parseHtmlToArray);
    };
